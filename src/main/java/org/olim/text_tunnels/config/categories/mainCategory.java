...
public class mainCategory {
    ...
    public static ConfigCategory create(TextTunnelsConfig defaults, TextTunnelsConfig config) {
        return ConfigCategory.createBuilder()
                .name(Component.translatable("text_tunnels.config.main.name"))
                .option(Option.<Boolean>createBuilder()
                        .name(Component.translatable("text_tunnels.config.main.enabled"))
                        .description(OptionDescription.of(Component.translatable("text_tunnels.config.main.enabled.@Tooltip")))
                        .binding(defaults.mainConfig.enabled, () -> config.mainConfig.enabled, newVal -> config.mainConfig.enabled = newVal)
                        .controller(TickBoxControllerBuilder::create)
                        .build())
                .option(Option.<Boolean>createBuilder()
                        .name(Component.translatable("text_tunnels.config.main.peakingEnabled"))
                        .description(OptionDescription.of(Component.translatable("text_tunnels.config.main.peakingEnabled.@Tooltip")))
                ...
                .group(OptionGroup.createBuilder()
                        .name(Component.translatable("text_tunnels.config.main.buttonStyle"))
                        .collapsed(true)
                        .option(Option.<Integer>createBuilder()
                                .name(Component.translatable("text_tunnels.config.main.buttonStyle.spacing"))
                                .description(OptionDescription.of(Component.translatable("text_tunnels.config.main.buttonStyle.spacing.@Tooltip")))
                                ...
                                .build())
                        .option(Option.<Integer>createBuilder()
                                .name(Component.translatable("text_tunnels.config.main.buttonStyle.heightOffset"))
                                .description(OptionDescription.of(Component.translatable("text_tunnels.config.main.buttonStyle.heightOffset.@Tooltip")))
                                ...
                                .build())
                        .option(Option.<Boolean>createBuilder()
                                .name(Component.translatable("text_tunnels.config.main.buttonStyle.fancyStyle"))
                                .description(OptionDescription.of(Component.translatable("text_tunnels.config.main.buttonStyle.fancyStyle.@Tooltip")))
                        ...
                        .build())
                .group(OptionGroup.createBuilder()
                        .name(Component.translatable("text_tunnels.config.main.unreadIndicators"))
                        .collapsed(true)
                        .option(Option.<Boolean>createBuilder()
                                .name(Component.translatable("text_tunnels.config.main.unreadIndicators.enabled"))
                                .description(OptionDescription.of(Component.translatable("text_tunnels.config.main.unreadIndicators.enabled.@Tooltip")))
                                ...
                                .build())
                        .option(Option.<Integer>createBuilder()
                                .name(Component.translatable("text_tunnels.config.main.unreadIndicators.scale"))
                                .description(OptionDescription.of(Component.translatable("text_tunnels.config.main.unreadIndicators.scale.@Tooltip")))
                        ...
                        .option(Option.<MainConfig.IndicatorStyle>createBuilder()
                                .name(Component.translatable("text_tunnels.config.main.unreadIndicators.style"))
                                .description(OptionDescription.of(Component.translatable("text_tunnels.config.main.unreadIndicators.style.@Tooltip")))
